<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="myphamnam.aspx.cs" Inherits="Webbandongho.WebForm4" %>
...
<body>
    ...
    <div class="up">
        <div class="abc">
            <a href="Trangchu.aspx"><strong>TRANG CHỦ</strong></a> / <a href="donghonam.aspx"><strong>MỸ PHẨM NAM</strong></a>
        </div>
    </div>
    ...
    <div class="timkiem">
        <from>
           <center>
               <tr>
                    <td>tìm kiếm</td>
                    <td><input type ="text" id="timkiem"/></td>
                </tr>
           </center>
        </from>
    </div>
