<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="locsp.aspx.cs" Inherits="Webbandongho.locsp" %>
    ...
    <div>
        <form>
            <center>
                ...
                <tr>
                    <td>tên sản phẩm</td>
                    <td><input type ="text" id="GIÁ SẢN PHẨM"/></td>
                </tr>
                 
                    <tr>
                        <td rowspan="2"> <input  type="button" value="TÌM KIẾM" onclick="checkdulieu()"/>
                    </td>
                    </tr>
            </table>
            </center>
